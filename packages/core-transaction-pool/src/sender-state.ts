import { Container, Contracts, Enums, Providers, Services } from "@cauriland/core-kernel";
import { Handlers } from "@cauriland/core-transactions";
import { Crypto, Interfaces, Managers } from "@cauriland/crypto";
...
export class SenderState implements Contracts.TransactionPool.SenderState {
    ...
    @Container.tagged("plugin", "@cauriland/core-transaction-pool")
