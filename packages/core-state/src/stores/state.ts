import { Container, Contracts, Enums, Providers, Utils } from "@cauriland/core-kernel";
import { Interfaces, Managers } from "@cauriland/crypto";
...
export class StateStore implements Contracts.State.StateStore {
    ...
    @Container.tagged("plugin", "@cauriland/core-state")
