...
import { Container, Contracts, Providers, Types, Utils } from "@cauriland/core-kernel";
import { Blocks, Interfaces, Managers } from "@cauriland/crypto";
...
export class SnapshotDatabaseService implements Database.DatabaseService {
    ...
    @Container.tagged("plugin", "@cauriland/core-snapshots")
    private readonly configuration!: Providers.PluginConfiguration;

    @Container.inject(Container.Identifiers.PluginConfiguration)
    @Container.tagged("plugin", "@cauriland/core-database")
