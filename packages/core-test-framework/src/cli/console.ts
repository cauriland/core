import { Application, ApplicationFactory, Commands, Container, Services, Utils } from "@cauriland/core-cli";
...
export class Console {
    ...
    private reset(): void {
        this.args = [];
        this.flags = this.useDefaultFlags ? { token: "cauri", network: "testnet" } : {};
    }
