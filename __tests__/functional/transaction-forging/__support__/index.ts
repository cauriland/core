...
import { StateBuilder } from "@cauriland/core-state/src/state-builder";
        ...
        await app.bootstrap({
            ...
            plugins: {
                include: [
                    ...
                    "@cauriland/core-magistrate-transactions",
                    "@cauriland/core-transaction-pool",
                    "@cauriland/core-p2p",
                    "@cauriland/core-blockchain",
                    "@cauriland/core-api",
                    "@cauriland/core-forger",
                ],
                options: {
                    "@cauriland/core-blockchain": {
                        networkStart: true,
