...
describe("MultiPaymentTransaction", () => {
    ...
    beforeEach(async () => {
        ...
        multiPaymentTransaction = BuilderFactory.multiPayment()
            .addPayment("CRYJmeYHSUTgbxaiqsgoPwf6M3CYukqdKN", "10")
            .addPayment("CFyjB5jULQiYNsp37wwipCm9c7V1xEzTJD", "20")
            .addPayment("CJwD3UJM7UESFnP1fsKYr4EX9Gc1EJNSqm", "30")
            .addPayment("CUsi9ZcFkcwG7WMpRE121TR4HaTjnAP7qD", "40")
            .addPayment("CRugw4i18i2pVnYZEMWKJj2mAnQQ97wuat", "50")
            .nonce("1")
            .sign(passphrases[0])
            .build();
