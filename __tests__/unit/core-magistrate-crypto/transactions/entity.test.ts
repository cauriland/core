...
import { Interfaces } from "@cauriland/core-magistrate-crypto";
import { EntityBuilder } from "@cauriland/core-magistrate-crypto/src/builders";
import { EntityTransaction } from "@cauriland/core-magistrate-crypto/src/transactions";
import { Managers, Transactions, Validation } from "@cauriland/crypto";
...
describe("Entity transaction", () => {
    ...
    describe("Ser/deser", () => {
        ...
        it.each(entityAssets)("should ser/deserialize giving back original fields", (asset) => {
            ...
            const entity = builder.network(28).asset(asset).sign("passphrase").getStruct();
        ...
        it.each(entitySpecialAssets)(
            ...
            (assetToSerialize, expectedDeserialized) => {
                ...
                const entity = builder.network(28).asset(assetToSerialize).sign("passphrase").getStruct();
