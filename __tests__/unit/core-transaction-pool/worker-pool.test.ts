...
import { Enums } from "@cauriland/crypto";
...
describe("WorkerPool.initialize", () => {
    it("should create workers", () => {
        const workerCount = 5;
        const cryptoPackages = [{ typeGroup: 2, packageName: "@cauriland/core-magistrate-crypto" }];
        ...
        expect(worker.loadCryptoPackage).toBeCalledWith("@cauriland/core-magistrate-crypto");
