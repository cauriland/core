...
describe("DatabaseCommand", () => {
    describe("Flags", () => {
        ...
        it("should set the database name", async () => {
            ...
            // Act
            await cli.withFlags({ database: "cauri_mainnet" }).execute(Command);

            // Assert
            expect(existsSync).toHaveBeenCalledWith(envFile);
            expect(parseFileSync).toHaveBeenCalledWith(envFile);
            expect(writeFileSync).toHaveBeenCalledWith(envFile, "CORE_DB_DATABASE=cauri_mainnet");
        ...
        it("should set the name of the database user", async () => {
            ...
            // Act
            await cli.withFlags({ username: "cauri" }).execute(Command, { flags: { username: "cauri" } });

            // Assert
            expect(existsSync).toHaveBeenCalledWith(envFile);
            expect(parseFileSync).toHaveBeenCalledWith(envFile);
            expect(writeFileSync).toHaveBeenCalledWith(envFile, "CORE_DB_USERNAME=cauri");
    ...
    describe("Prompts", () => {
        ...
        it("should set the database name", async () => {
            ...
            // Act
            prompts.inject([undefined, undefined, "cauri_mainnet", undefined, undefined, true]);
            ...
            expect(existsSync).toHaveBeenCalledWith(envFile);
            expect(parseFileSync).toHaveBeenCalledWith(envFile);
            expect(writeFileSync).toHaveBeenCalledWith(envFile, expect.toInclude("CORE_DB_DATABASE=cauri_mainnet"));
        ...
        it("should set the name of the database user", async () => {
            ...
            // Act
            prompts.inject([undefined, undefined, undefined, "cauri", undefined, true]);
            ...
            expect(existsSync).toHaveBeenCalledWith(envFile);
            expect(parseFileSync).toHaveBeenCalledWith(envFile);
            expect(writeFileSync).toHaveBeenCalledWith(envFile, expect.toInclude("CORE_DB_USERNAME=cauri"));
