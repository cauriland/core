...
import { PublicKey } from "@cauriland/crypto/src/identities";
import { Errors } from "@cauriland/crypto-identities";
...
describe("Identities - Address", () => {
    ...
    describe("toBuffer", () => {
        ...
        it("should not be OK", () => {
            expect(Address.toBuffer("CdVSe37niA3uFUPgCgMUH2tMsHF4LpLoiX").addressError).not.toBeUndefined();
        });
    });
    ...
    describe("validate", () => {
        ...
        it("should validate MAINNET addresses", () => {
            ...
            expect(Address.validate("CdVSe37niA3uFUPgCgMUH2tMsHF4LpLoiX")).toBeTrue();
        });
