...
import { CAUTOSHI } from "../../../../packages/crypto/src/constants";
...
describe("Transfer Transaction", () => {
    ...
    const fee = 1 * CAUTOSHI;
    const amount = 10 * CAUTOSHI;
    ...
    it("should be valid after a network change", () => {
        ...
        transfer = transaction
            .recipientId("CPnDzjtDb1FthuqcLMeL5XMWb1uD1KeMGi")
            .amount("1")
            .fee("1")
            .network(configManager.get("network.pubKeyHash"))
            .sign("passphrase")
        ...
        expect(transfer.data.network).toBe(28);
