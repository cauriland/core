...
import { Hash } from "@cauriland/crypto/src/crypto";
import { TransactionVersionError } from "@cauriland/crypto/src/errors";
import { Keys } from "@cauriland/crypto/src/identities";
import { BuilderFactory, Utils as TransactionUtils, Verifier } from "@cauriland/crypto/src/transactions";
...
describe("Verifier", () => {
    describe("verify", () => {
        const transaction = TransactionFactory.initialize()
            .transfer("CJWRd23HNEhPLkK1ymMnwnDBX2a7QBZqff", 1000)
            .withVersion(2)
            .withFee(2000)
