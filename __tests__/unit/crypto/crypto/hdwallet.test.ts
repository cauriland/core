...
describe("HDWallet", () => {
    describe("bip32", () => {
        it("can create a BIP32 wallet external address", () => {
            ...
            expect(Address.fromPublicKey(child1.publicKey.toString("hex"))).toBe("CaDeMzugpBiBqgoQnd8FiEpw8ocWBwhkQZ");
            expect(Address.fromPublicKey(child2.publicKey.toString("hex"))).toBe("CaDeMzugpBiBqgoQnd8FiEpw8ocWBwhkQZ");
        });
    });

    describe("bip44", () => {
        it("can create a BIP44, cauri, account 0, external address", () => {
            ...
            expect(Address.fromPublicKey(child1.publicKey.toString("hex"))).toBe("CLKtp6wJWtxdAELSU9gFqdCCzG6Licg91m");
            expect(Address.fromPublicKey(child2.publicKey.toString("hex"))).toBe("CLKtp6wJWtxdAELSU9gFqdCCzG6Licg91m");
        });
    });
    ...
    describe("deriveSlip44", () => {
        it("should derive path", () => {
            ...
            expect(Address.fromPublicKey(actual.publicKey.toString("hex"))).toBe("CJ6iAQpx4yVz261ZACKcH7LVi5Pq3ojpEw");
    ...
    describe("deriveNetwork", () => {
        it("should derive path", () => {
            ...
            expect(Address.fromPublicKey(actual.publicKey.toString("hex"))).toBe("CLRCjcyTWATzAZ7Gc2ZXKRdg5KFsfBw3vZ");
            expect(actual.publicKey.toString("hex")).toBe(
