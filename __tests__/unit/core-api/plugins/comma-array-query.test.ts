...
describe("commaArrayQuery.onRequest", () => {
    it("should replace comma separated query parameter by array", () => {
        const addresses = [
            "CXGc1bgU3v3rHmx9WVkUUHLA6gbzh8La7V",
            "CQvWbCAXbBnY9fHpgNrcLZ99hYfDifH4Hs",
            "CTKegneyu9Fkoj5FxiJ3biup8xv8zM34M3",
        ];
        const request = {
            query: {
    ...
    it("should leave as-is query parameter without comma", () => {
        const address = "CXGc1bgU3v3rHmx9WVkUUHLA6gbzh8La7V";
        const request = {
            query: {
                address,
            },
