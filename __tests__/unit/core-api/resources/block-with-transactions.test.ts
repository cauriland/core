...
const transaction = {
    ...
    typeGroup: 1,
    recipientId: "CJjv7WztjJNYHrLAeveG5NgHWp6699ZJwD",
...
const blockWithTransactionDataTransformed = {
    ...
    generator: {
        username: "genesis_13",
        address: "CNRNMPjQjJGVsVbyeqwShcxKTidYJ2S1Hm",
    ...
    timestamp: {
        epoch: 103497376,
        unix: 1752788955,
        human: "2025-07-17T21:49:15.820Z",
    },
};
...
beforeEach(() => {
    mockWallet = {
        getAddress: () => {
            return "CNRNMPjQjJGVsVbyeqwShcxKTidYJ2S1Hm";
        },
        getPublicKey: () => {
