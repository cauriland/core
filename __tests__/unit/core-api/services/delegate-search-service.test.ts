...
describe("DelegateSearchService", () => {
    describe("getDelegate", () => {
        it("should return delegate by wallet address", () => {
            ...
            expect(delegateSearchService.getDelegate("CNBkoGqWeTSiaEVgVzSKZd3jS7UWzv9PSo")).toEqual(
        ...
        it("should return undefined if walled is not delegate", () => {
            ...
            expect(delegateSearchService.getDelegate("CNBkoGqWeTSiaEVgVzSKZd3jS7UWzv9PSo")).toBeUndefined();
        });
    });
