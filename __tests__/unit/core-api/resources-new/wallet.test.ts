...
describe("walletCriteriaSchemaObject.address", () => {
    it("should allow correct address", () => {
        const result = walletCriteriaSchemaObject.address.validate("CXzxJ8Ts3dQ2bvBR1tPE7GUee9iSEJb8HX");
    ...
    it("should allow like expression", () => {
        const result = walletCriteriaSchemaObject.address.validate("CX%");
        expect(result.error).toBe(undefined);
    });
