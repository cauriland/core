import { DelegateSearchService, Resources, WalletSearchService } from "@cauriland/core-api";
import { DelegatesController } from "@cauriland/core-api/src/controllers/delegates";
import { Identifiers } from "@cauriland/core-api/src/identifiers";
import { Application, Container, Contracts, Providers } from "@cauriland/core-kernel";
import { Enums, Utils } from "@cauriland/crypto";
...
const delegateWalletResource: Resources.WalletResource = {
    address: "CKdr5d9AMEnsKYxpDcoHdyyjSCKVx3r9Nj",
...
const voterWalletResource: Resources.WalletResource = {
    address: "CTL9kyo71wjPPXqvGMUD89t5RazmQfQMc6",
    ...
    describe("Show", () => {
        it("should get delegate id from pathname and return delegate from DelegateSearchService", () => {
            ...
            const result = delegatesController.show({
                params: {
                    id: "CKdr5d9AMEnsKYxpDcoHdyyjSCKVx3r9Nj",
                },
            });

            expect(walletSearchService.getWallet).toBeCalledWith("CKdr5d9AMEnsKYxpDcoHdyyjSCKVx3r9Nj");
        ...
        it("should return 404 when wallet isn't delegate", () => {
            ...
            const result = delegatesController.show({
                params: {
                    id: "CTL9kyo71wjPPXqvGMUD89t5RazmQfQMc6",
                },
            });

            expect(walletSearchService.getWallet).toBeCalledWith("CTL9kyo71wjPPXqvGMUD89t5RazmQfQMc6");
