import { LockSearchService, Resources, WalletSearchService } from "@cauriland/core-api";
import { WalletsController } from "@cauriland/core-api/src/controllers/wallets";
...
const walletResource1: Resources.WalletResource = {
    address: "CTrkBiUXGDKduaSjqez2Ar7T9rQW6cnaeu",
...
const walletResource2Cold: Resources.WalletResource = {
    address: "CdawBmuTYzjNgrYgDEbZVzPbYLvYnBin2Y",
...
const wallet1LockResource1: Resources.LockResource = {
    ...
    recipientId: "CXm433vapiwt83xfh8x9ciNxYkVd76pbNe",
    timestamp: {
        epoch: 108158400,
        unix: 1598259600,
