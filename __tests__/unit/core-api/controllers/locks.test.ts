import { LockSearchService, Resources } from "@cauriland/core-api";
import { LocksController } from "@cauriland/core-api/src/controllers/locks";
...
const lockResource1: Resources.LockResource = {
    ...
    vendorField: "CauriPool payments",
};
