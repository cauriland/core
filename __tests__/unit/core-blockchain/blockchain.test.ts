...
import { ProcessBlocksJob } from "@cauriland/core-blockchain/src/process-blocks-job";
import { Queue } from "@cauriland/core-kernel/dist/contracts/kernel";
import { Identifiers, interfaces } from "@cauriland/core-kernel/dist/ioc";
import { MemoryQueue } from "@cauriland/core-kernel/src/services/queue/drivers/memory";
...
describe("Blockchain", () => {
    ...
    describe("enqueueBlocks", () => {
        ...
        it("should push a chunk to the queue when hitting new milestone", async () => {
            ...
            const blockMilestone = { id: "123", height: 324000 } as Interfaces.IBlockData;
            const blockAfterMilestone = { id: "456", height: 324001 } as Interfaces.IBlockData;
