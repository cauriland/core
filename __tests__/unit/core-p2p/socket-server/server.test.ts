...
import * as Nes from "@cauriland/core-p2p/src/hapi-nes";
import { Server } from "@cauriland/core-p2p/src/socket-server/server";
...
describe("Server", () => {
    ...
    const options = { hostname: "127.0.0.1", port: 4300 };
