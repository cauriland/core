    ...
    describe("analyze", () => {
        ...
        describe("when returning quorum details", () => {
            it("should return accurate quorum values peersNoQuorum peersQuorum peersForked", async () => {
                ...
                const peer1 = new Peer("181.168.65.65", 4300);
                peer1.state = {
                ...
                const peer5 = new Peer("185.168.65.65", 4300);
