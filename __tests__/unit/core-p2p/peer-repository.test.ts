...
import { PeerRepository } from "@cauriland/core-p2p/src/peer-repository";
...
describe("PeerRepository", () => {
    ...
    describe("getPeers", () => {
        it("should return all the peers in an array", () => {
            const peers = [
                new Peer("176.165.66.55", 4300),
                new Peer("176.165.44.33", 4300),
    ...
    describe("getPeer", () => {
        it("should return the peer by its ip", () => {
            const peersByIp = {
                "176.165.66.55": new Peer("176.165.66.55", 4300),
                "176.165.44.33": new Peer("176.165.44.33", 4300),
                "2001:3984:3989::104": new Peer("2001:3984:3989::104", 4300),
            };
    ...
    describe("forgetPeer", () => {
        it("should forget the peer", () => {
            const peer = new Peer("176.165.66.55", 4300);
    ...
    describe("getPendingPeers", () => {
        it("should return the pending peers", () => {
            const peers = [new Peer("176.165.66.55", 4300), new Peer("176.165.44.33", 4300)];
