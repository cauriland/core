...
describe("DaemonizeProcess", () => {
    it("should throw if the process has entered an unknown state", () => {
        ...
        ).toThrow('The "cauri-core" process has entered an unknown state.');

        expect(has).toHaveBeenCalledWith("cauri-core");
        expect(isUnknown).toHaveBeenCalledWith("cauri-core");
    ...
    it("should throw if the process is running", () => {
        ...
        ).toThrow('The "cauri-core" process is already running.');

        expect(has).toHaveBeenCalledWith("cauri-core");
        expect(isUnknown).toHaveBeenCalledWith("cauri-core");
        expect(isOnline).toHaveBeenCalledWith("cauri-core");
    ...
    it("should continue execution if the process does not exist", () => {
        ...
        expect(has).toHaveBeenCalledWith("cauri-core");
        expect(isUnknown).not.toHaveBeenCalledWith("cauri-core");
        expect(isOnline).not.toHaveBeenCalledWith("cauri-core");
    ...
    it("should run with the [no-daemon] flag if the daemon flag is not set", () => {
        ...
        expect(start).toHaveBeenCalledWith(
            ...
            { "kill-timeout": 30000, "max-restarts": 5, name: "cauri-core", "no-daemon": true },
        );
    ...
    it("should run without the [--no-daemon] flag if the daemon flag is true", () => {
        ...
        expect(start).toHaveBeenCalledWith(
            ...
            { "kill-timeout": 30000, "max-restarts": 5, name: "cauri-core" },
        );
