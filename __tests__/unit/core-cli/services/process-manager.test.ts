...
import { Contracts } from "@cauriland/core-cli";
...
describe("ProcessManager", () => {
    ...
    describe("#trigger", () => {
        it(".trigger()", async () => {
            ...
            // Act...
            const { failed } = await processManager.trigger("cauri-core", "module.name", "params");

            // Assert...
            expect(failed).toBeFalse();
            expect(execa).toHaveBeenCalledWith("pm2 trigger cauri-core module.name params", { shell: true });
        });
    });
