...
describe("Installer.install", () => {
    it("should install latest package when tag isn't provided", () => {
        ...
        installer.install("@cauriland/core");

        expect(spySync).toHaveBeenCalledWith("rm -f \"`yarn global dir`\"/node_modules/better-sqlite3/build/Release/better_sqlite3.node && yarn global add @cauriland/core@latest --force", { shell: true });
    });
    ...
    it("should install specific package when tag is provided", () => {
        ...
        installer.install("@cauriland/core", "3.0.0");

        expect(spySync).toHaveBeenCalledWith("rm -f \"`yarn global dir`\"/node_modules/better-sqlite3/build/Release/better_sqlite3.node && yarn global add @cauriland/core@3.0.0 --force", { shell: true });
    });
    ...
    it("should throw when exit code isn't 0", () => {
        ...
        expect(() => installer.install("@cauriland/core")).toThrow("stderr");
...
describe("Installer.installPeerDependencies", () => {
    it("should install each peer dependency", () => {
        ...
        installer.installPeerDependencies("@cauriland/core", "3.0.0");

        expect(spySync).toHaveBeenCalledWith("yarn info @cauriland/core@3.0.0 peerDependencies --json", {
            shell: true,
        });
    ...
    it("should throw error when yarn command fails", () => {
        ...
        expect(() => installer.installPeerDependencies("@cauriland/core")).toThrow("stderr");

        expect(spySync).toHaveBeenCalledWith("yarn info @cauriland/core@latest peerDependencies --json", {
            shell: true,
        });
    });
});
...
describe("Installer.installRangeLatest", () => {
    it("should install highest matching version", () => {
        ...
        installer.installRangeLatest("@cauriland/core", "^3.0.0 <3.4.0");

        expect(spySync).toHaveBeenCalledWith("yarn info @cauriland/core versions --json", {
            shell: true,
        });

        expect(spyInstall).toHaveBeenCalledWith("@cauriland/core", "3.1.0");
    });
    ...
    it("should throw error when command fails", () => {
        ...
        expect(() => installer.installRangeLatest("@cauriland/core", "^3.0.0 <3.4.0")).toThrow("stderr");
    ...
    it("should throw error when there is no version matching requested range", () => {
        ...
        expect(() => installer.installRangeLatest("@cauriland/core", "^4.0.0 <4.4.0")).toThrow(
            "No @cauriland/core version to satisfy ^4.0.0 <4.4.0",
        );
