...
describe("NPM", () => {
    describe("#exists", () => {
                ...
                .reply(200, {
                    ...
                    versions: {
                        "1.3.1": {
                            ...
                            version: "1.3.1",
                            dist: {
                                tarball: "https://registry.npmjs.org/@cauriland/utils/-/utils-1.3.1.tgz",
                            },
                        },
                    },
                });

            await expect(source.exists("@cauriland/utils")).resolves.toBeTrue();
        });
        ...
        it("should return true if the file by version exists", async () => {
            ...
            await expect(source.exists("@cauriland/utils", "1.3.1")).resolves.toBeTrue();
        });
        ...
        it("should return false if the file by version doesn't exists", async () => {
            ...
            await expect(source.exists("@cauriland/utils", "0.5.5")).resolves.toBeFalse();
        });
    ...
    describe("#update", () => {
        it("should successfully install the plugin", async () => {
            ...
            nock(/.*/)
                .get("/@cauriland/utils/-/utils-1.3.1.tgz")
                .reply(200, fs.readFileSync(resolve(__dirname, "utils-1.3.1.tgz")));
            ...
            // Act
            const packageName: string = "@cauriland/utils";
