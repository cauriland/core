...
describe("File", () => {
    ...
    describe("#install", () => {
        it("should successfully install the plugin", async () => {
            // Arrange
            const fileName: string = join(__dirname, "utils-1.3.1.tgz");
        ...
        it("should throw error if .tgz doesn't contains package folder", async () => {
            // Arrange
            const fileName: string = join(__dirname, "invalid-utils-1.3.1.tgz");
        ...
        it("should throw error if .tgz doesn't contains package.json", async () => {
            // Arrange
            const fileName: string = join(__dirname, "missing-utils-1.3.1.tgz");
