...
beforeEach(() => {
    ...
    proc = cli.app.get(Container.Identifiers.ProcessFactory)("cauri", "core");
});
...
describe("Process", () => {
    describe("#stop", () => {
        it("should throw if the process does not exist", () => {
            ...
            expect(() => proc.stop()).toThrowError('The "cauri-core" process does not exist.');
        ...
        it("should throw if the process entered an unknown state", () => {
            ...
            expect(() => proc.stop()).toThrowError('The "cauri-core" process has entered an unknown state.');
        ...
        it("should throw if the process is stopped", () => {
            ...
            expect(() => proc.stop()).toThrowError('The "cauri-core" process is not running.');
    ...
    describe("#restart", () => {
        it("should throw if the process does not exist", () => {
            ...
            expect(() => proc.restart()).toThrowError('The "cauri-core" process does not exist.');
        ...
        it("should throw if the process is stopped", () => {
            ...
            expect(() => proc.restart()).toThrowError('The "cauri-core" process is not running.');
    ...
    describe("#status", () => {
        it("should throw if the process does not exist", async () => {
            expect(() => proc.status()).toThrow('The "cauri-core" process does not exist.');
        });
    ...
    describe("#log", () => {
        it("should throw if the process does not exist", async () => {
            await expect(proc.log()).rejects.toThrow('The "cauri-core" process does not exist.');
        });
        ...
        it("should log to pm_out_log_path", async () => {
            ...
            expect(spyLog).toHaveBeenCalledWith(
                "Tailing last 15 lines for [cauri-core] process (change the value with --lines option)",
            );
        });
